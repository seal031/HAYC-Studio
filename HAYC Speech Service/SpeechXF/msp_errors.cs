public enum ERROR : int
{
    ...
    MSP_ERROR_NO_LICENSE = 10110, // 引擎授权不足 
    MSP_ERROR_NOT_INIT = 10111, // 引擎未初始化,可能是引擎崩溃 
    MSP_ERROR_NULL_HANDLE = 10112, // 0x2780 
    MSP_ERROR_OVERFLOW = 10113, // 单用户下模型数超上限(10个), 
    MSP_ERROR_TIME_OUT = 10114, // 超时 
    MSP_ERROR_OPEN_FILE = 10115, // 0x2783 
    MSP_ERROR_NOT_FOUND = 10116, // 数据库中模型不存在 
    MSP_ERROR_NO_ENOUGH_BUFFER = 10117, // 0x2785 
    MSP_ERROR_NO_DATA = 10118, // 从客户端读音频或从引擎段获取结果时无数据 
    MSP_ERROR_NO_MORE_DATA = 10119, // 0x2787 
    MSP_ERROR_NO_RESPONSE_DATA = 10120, // 0x2788 


    MSP_ERROR_ALREADY_EXIST = 10121, // 数据库中模型已存在 
    ...
    MSP_ERROR_MESSAGE_NOT_COMPLETE = 10133, // flash 
    MSP_ERROR_NO_EID = 10134, // 0x2795 


    MSP_ERROE_OVER_REQ = 10135, // client Redundancy request 


    MSP_ERROR_USER_ACTIVE_ABORT = 10136, // user abort 
    ...
    MSP_ERROR_BOS_TIMEOUT = 10140, // VAD前端点超时 

    // Error codes of network 10200(0x27D8)
    MSP_ERROR_NET_GENERAL = 10200, // 0x27D8 


    MSP_ERROR_NET_OPENSOCK = 10201, // Open socket 


    MSP_ERROR_NET_CONNECTSOCK = 10202, // Connect socket 


    MSP_ERROR_NET_ACCEPTSOCK = 10203, // Accept socket 


    MSP_ERROR_NET_SENDSOCK = 10204, // Send socket data 


    MSP_ERROR_NET_RECVSOCK = 10205, // Recv socket data 


    MSP_ERROR_NET_INVALIDSOCK = 10206, // Invalid socket handle 


    MSP_ERROR_NET_BADADDRESS = 10207, // Bad network address 


    MSP_ERROR_NET_BINDSEQUENCE = 10208, // Bind after listen/connect 


    MSP_ERROR_NET_NOTOPENSOCK = 10209, // Socket is not opened 


    MSP_ERROR_NET_NOTBIND = 10210, // Socket is not bind to an address 


    MSP_ERROR_NET_NOTLISTEN = 10211, // Socket is not listening 


    MSP_ERROR_NET_CONNECTCLOSE = 10212, // The other side of connection is closed 


    MSP_ERROR_NET_NOTDGRAMSOCK = 10213, // The socket is not datagram type 


    MSP_ERROR_NET_DNS = 10214, // domain name is invalid or dns server does not function well 


    MSP_ERROR_NET_INIT = 10215, // ssl ctx create failed 
    ...
    MSP_ERROR_MSG_LOGIN_ID_EMPTY = 10311, // 音频序列ID为空 
    ...
    MSP_ERROR_MSG_INVALID_SESSION_ID = 10324, // 无效的会话ID(sid) 
    MSP_ERROR_MSG_INVALID_CONTENT = 10325, // 0x2855 

    // Error codes of DataBase 10400(0x28A0)


    MSP_ERROR_DB_GENERAL = 10400, // 数据库异常 
    MSP_ERROR_DB_EXCEPTION = 10401, // 0x28A1 


    MSP_ERROR_DB_NO_RESULT = 10402, // redis中没有找到会话ID(sid) 
    ...
    MSP_ERROR_RES_LOAD = 10501, // Load resource 


    MSP_ERROR_RES_FREE = 10502, // Free resource 


    MSP_ERROR_RES_MISSING = 10503, // Resource File Missing 


    MSP_ERROR_RES_INVALID_NAME = 10504, // Invalid resource file name 


    MSP_ERROR_RES_INVALID_ID = 10505, // Invalid resource ID 


    MSP_ERROR_RES_INVALID_IMG = 10506, // Invalid resource image pointer 


    MSP_ERROR_RES_WRITE = 10507, // Write read-only resource 


    MSP_ERROR_RES_LEAK = 10508, // Resource leak out 


    MSP_ERROR_RES_HEAD = 10509, // Resource head currupt 


    MSP_ERROR_RES_DATA = 10510, // Resource data currupt 


    MSP_ERROR_RES_SKIP = 10511, // Resource file skipped 

    // Error codes of TTS 10600(0x2968)
    MSP_ERROR_TTS_GENERAL = 10600, // 0x2968 


    MSP_ERROR_TTS_TEXTEND = 10601, // Meet text end 


    MSP_ERROR_TTS_TEXT_EMPTY = 10602, // no synth text 
    MSP_ERROR_TTS_LTTS_ERROR = 10603, // 0x296B 

    // Error codes of Recognizer 10700(0x29CC) 


    MSP_ERROR_REC_GENERAL = 10700, // 引擎异常 
    ...
    MSP_ERROR_TUV_GETHIDPARAM = 10901, // Get Busin Param huanid


    MSP_ERROR_TUV_TOKEN = 10902, // Get Token 


    MSP_ERROR_TUV_CFGFILE = 10903, // Open cfg file 


    MSP_ERROR_TUV_RECV_CONTENT = 10904, // received content is error 


    MSP_ERROR_TUV_VERFAIL = 10905, // Verify failure 

    // Error codes of IMTV 


    MSP_ERROR_LOGIN_SUCCESS = 11000, // 成功 


    MSP_ERROR_LOGIN_NO_LICENSE = 11001, // 试用次数结束，用户需要付费 


    MSP_ERROR_LOGIN_SESSIONID_INVALID = 11002, // SessionId失效，需要重新登录通行证 


    MSP_ERROR_LOGIN_SESSIONID_ERROR = 11003, // SessionId为空，或者非法 


    MSP_ERROR_LOGIN_UNLOGIN = 11004, // 未登录通行证 


    MSP_ERROR_LOGIN_INVALID_USER = 11005, // 用户ID无效 


    MSP_ERROR_LOGIN_INVALID_PWD = 11006, // 用户密码无效 
    ...
    MSP_ERROR_AUTH_LOCAL_ASR_FORBIDDEN = 11207, // 禁止使用本地识别引擎 


    MSP_ERROR_AUTH_LOCAL_TTS_FORBIDDEN = 11208, // 禁止使用本地合成引擎 


    MSP_ERROR_AUTH_LOCAL_IVW_FORBIDDEN = 11209, // 禁止使用本地唤醒引擎 


    MSP_ERROR_AUTH_APPID_NOT_MATCH = 11210, // 资源appid和应用appid不匹配 


    MSP_ERROR_AUTH_UID_NOT_MATCH = 11211, // 资源uid和登录用户uid不匹配 


    MSP_ERROR_AUTH_TRIAL_EXPIRED = 11212, // 试用资源过期 


    MSP_ERROR_AUTH_LOCAL_IFD_FORBIDDEN = 11213, // 禁止使用本地人脸引擎 
    ...
    MSP_ERROR_ISV_NO_USER = 13000, // the user doesn't exist 
    ...
    MSP_ERROR_MMP_MAIL_SESSION_FAIL = 15006, // 邮件登陆服务器时，会话错误。


    MSP_ERROR_MMP_MAIL_LOGON_FAIL = 15007, // 邮件登陆服务器时，拒绝登陆。


    MSP_ERROR_MMP_MAIL_USER_ILLEGAL = 15008, // 邮件登陆服务器时，用户名非法。


    MSP_ERROR_MMP_MAIL_PWD_ERR = 15009, // 邮件登陆服务器时，密码错误。


    MSP_ERROR_MMP_MAIL_SOCKET_ERR = 15010, // 邮件发送过程中套接字错误


    MSP_ERROR_MMP_MAIL_INIT_FAIL = 15011, // 邮件初始化错误


    MSP_ERROR_MMP_STORE_MNR_NO_INIT = 15012, // store_manager未初始化，或初始化失败


    MSP_ERROR_MMP_STORE_MNR_POOL_FULL = 15013, // store_manager的连接池满了


    MSP_ERROR_MMP_STRATGY_PARAM_ILLEGAL = 15014, // 报警策略表达式非法


    MSP_ERROR_MMP_STRATGY_PARAM_TOOLOOG = 15015, // 报警策略表达式太长


    MSP_ERROR_MMP_PARAM_NULL = 15016, // 函数参数为空


    MSP_ERROR_MMP_ERR_MORE_TOTAL = 15017, // pms插入数据库中错误汇总表的数据，错误次数 > 总次数。


    MSP_ERROR_MMP_PROC_THRESHOLD = 15018, // 进程监控阀值设置错误


    MSP_ERROR_MMP_SERVER_THRESHOLD = 15019, // 服务器监控阀值设置错误


    MSP_ERROR_MMP_PYTHON_NO_EXIST = 15020, // python脚本文件不存在 


    MSP_ERROR_MMP_PYTHON_IMPORT_FAILED = 15021, // python脚本导入出错 


    MSP_ERROR_MMP_PYTHON_BAD_FUNC = 15022, // python脚本函数格式错误 


    MSP_ERROR_MMP_DB_DATA_ILLEGAL = 15023, // 插入数据库中的数据格式有误 


    MSP_ERROR_MMP_REDIS_NOT_CONN = 15024, // redis没有连接到服务端 


    MSP_ERROR_MMP_PMA_NOT_FOUND_STRATEGY = 15025, // 没有找到报警策略 


    MSP_ERROR_MMP_TAIR_CONNECT = 15026, // 连接tair集群失败 


    MSP_ERROR_MMP_PMC_SERVINFO_INVALID = 15027, // 此pmc的服务器信息已经无效 


    MSP_ERROR_MMP_ALARM_GROUP_NULL = 15028, // 服务器报警的短信报警组与邮件报警组均为空 


    MSP_ERROR_MMP_ALARM_CONTXT_NULL = 15029, // 服务器报警的报警内容为空 

    // Error codes of MSC(lmod loader) 
    MSP_ERROR_LMOD_BASE = 16000, // 0x3E80 


    MSP_ERROR_LMOD_NOT_FOUND = 16001, // 没找到lmod文件 


    MSP_ERROR_LMOD_UNEXPECTED_BIN = 16002, // 无效的lmod 


    MSP_ERROR_LMOD_LOADCODE = 16003, // 加载lmod指令失败 


    MSP_ERROR_LMOD_PRECALL = 16004, // 初始化lmod失败 


    MSP_ERROR_LMOD_RUNTIME_EXCEPTION = 16005, // lmod运行时异常 


    MSP_ERROR_LMOD_ALREADY_LOADED = 16006, // lmod重复加载 

    // Error code of Third Business


    MSP_ERROR_BIZ_BASE = 17000, // lmod重复加载 
